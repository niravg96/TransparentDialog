...
public class ShapeLinearLayout extends LinearLayout {
    ...
    public ShapeLinearLayout(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public ShapeLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ShapeLinearLayout);
            int BG_Color = a.getColor(R.styleable.ShapeLinearLayout_BgColorLl, -101);
            int strokeColor = a.getColor(R.styleable.ShapeLinearLayout_StrokeColorLl, -101);
            float cornerRadius = a.getDimension(R.styleable.ShapeLinearLayout_CornerRadiusLl, 0);
            float strokeWidth = a.getDimension(R.styleable.ShapeLinearLayout_StrokeWidthLl, 0);
